      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <Type className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <Calculator className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <Languages className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <Smartphone className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
