        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <MessageSquare className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <List className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
                <Download className="w-10 h-10 text-blue-500 mr-4 shrink-0" />
                <div>
                  <h3 className="font-semibold mb-1">
